...
const Footer = () => {
  return (
    <footer className="w-full bg-opacity-30 bg-black">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        {/*Grid*/}
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
          <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
            <Link
              to="https://github.com/oluwaseg"
              className="flex justify-center lg:justify-start items-center"
              onClick={(e) => e.preventDefault()}
            >
              <img src={logo} className="block h-10 w-auto" alt="" />
            ...
            <Link
              to="mailto:samueloluwasegun999@gmail.com"
        ...
        <div className="py-7 border-t border-gray-200">
          <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
            <span className="text-sm text-white ">
              Created by ©
              <Link className="ml-1" to="https://github.com/oluwaseg">
                Oluwasegun
              </Link>{" "}
            ...
            <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
              <Link
                to="javascript:;"
                className="w-9 h-9 rounded-full bg-opacity-75 bg-black flex justify-center items-center hover:bg-indigo-600"
              >
                <svg
